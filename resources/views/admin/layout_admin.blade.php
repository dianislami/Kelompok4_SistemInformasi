...
<body>
    ...
    <div class="topbar">
        ...
        {{-- Profile + Logout --}}
        <div class="profile">
            <span>{{ session('admin')->nama ?? 'Guest' }}</span>
    ...
    {{-- Sidebar --}}
    <div class="sidebar">
        <a href="{{ url('/dashboard_admin') }}" class="sidebar-item {{ request()->is('dashboard_admin') ? 'active' : '' }}">
            <span class="wrapper top">
                <img src="{{ request()->is('dashboard_admin') ? asset('assets/home.png') : asset('assets/home1.png') }}" class="logo-item">
            </span>
            Beranda
        </a>
        <a href="{{ url('/daftar_laporan') }}" class="sidebar-item {{ request()->is('daftar_laporan') ? 'active' : '' }}">
            <span class="wrapper">
                <img src="{{ request()->is('daftar_laporan') ? asset('assets/lost.png') : asset('assets/lost1.png') }}" class="logo-item">
            </span>
            Daftar <br>Laporan
        </a>
        <a href="{{ url('/daftar_klaim') }}" class="sidebar-item {{ request()->is('daftar_klaim') ? 'active' : '' }}">
            <span class="wrapper">
                <img src="{{ request()->is('daftar_klaim') ? asset('assets/found.png') : asset('assets/found1.png') }}" class="logo-item">
            </span>
            Daftar <br>Klaim
        </a>
        <a href="{{ url('/profil_admin') }}" class="sidebar-item {{ request()->is('profil_admin') ? 'active' : '' }}">
            <span class="wrapper bottom">
                <img src="{{ request()->is('profil_admin') ? asset('assets/profile.png') : asset('assets/profile1.png') }}" class="logo-item">
            </span>
            Profil
        </a>
    </div>
