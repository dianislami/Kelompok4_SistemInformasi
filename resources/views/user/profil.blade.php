  ...
  <div class="profile-info">
    ...
    <div class="profile-details">
      <div class="detail-row">
        ...
        <div class="detail-item">
          <h3 class="detail-label">NPM</h3>
          <p class="detail-value">{{ $user->npm ?? '-' }}</p>
        </div>
        
        <div class="detail-item">
          <h3 class="detail-label">Prodi</h3>
          <p class="detail-value">{{ $user->prodi ?? '-' }}</p>
        </div>
      ...
      <div class="modal-body">
        ...
        <form id="editProfileForm">
          ...
          <div class="form-group">
            ...
            <input type="text" id="npmInput" name="npm" class="form-input" value="{{ $user->npm }}" />
          </div>
          
          <div class="form-group">
            <label for="prodiInput">Prodi</label>
            <input type="text" id="prodiInput" name="prodi" class="form-input" value="{{ $user->prodi }}" />
          </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    editForm.addEventListener('submit', function(event) {
      ...
      detailValues[1].textContent = npm;  // NPM
      detailValues[2].textContent = prodi; // prodi
